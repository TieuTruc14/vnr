...
<section id="content">
    <section class="vbox">
        <section class="scrollable padder">
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in"> <li><a href="/mdms/index.action"><i class="fa fa-home"></i> Trang chủ</a></li> <li><a href="/mdms/report/index.action">Hạ tầng</a></li> <li><a href="#">Quản lý đoàn tàu mẫu</a></li></ul>
            <div class="m-b-md"> <h3 class="m-b-none">Sửa thông tin đoàn tàu mẫu</h3> </div>
            ...
            <section class="panel panel-default">
                ...
                <section class="panel-body">
                    <s:form id="filter" label="Tìm kiếm " action="train.edit.action" theme="simple" enctype="multipart/form-data" cssClass="form-horizontal" cssStyle="" validate="false">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Mác tàu</label>
                            <div class="col-sm-9">
