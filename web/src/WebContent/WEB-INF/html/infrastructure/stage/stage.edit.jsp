...
<section id="content">
    <section class="vbox">
        <section class="scrollable padder">
            ...
            <div class="m-b-md"> <h3 class="m-b-none">Sửa khu đoạn</h3> </div>
            ...
            <section class="panel panel-default">
                ...
                <section class="panel-body">
                    <s:form id="filter" label="Tìm kiếm " action="stage.edit.action" theme="simple" enctype="multipart/form-data" cssClass="form-horizontal" cssStyle="" validate="false">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Độ dài khu đoạn(km)</label>
                            <div class="col-sm-10">
