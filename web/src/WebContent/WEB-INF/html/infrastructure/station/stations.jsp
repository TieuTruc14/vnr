    ...
    <section class="vbox">
        <section class="scrollable padder">
            <div class="m-b-md">
                ...
                <h3 class="m-b-none">Danh sách Nhà Ga</h3>
                <%--<label class="btn btn-sm btn-success pull-right" style="position: relative;top:-25px;"><i class="fa fa-check text-active"></i><a href="station.addnew.action" style="color:#ffffff;"> Thêm ga </a></label>--%>
            </div>
                                    ...
                                    <td>
                                        <%--<div class="btn-group">--%>
                                            ...
                                            <%--<ul class="dropdown-menu pull-right">--%>
                                                <%--<li><a href="/vnr/infrastructure/station.edit.action?stationId=<s:property value="#item.id" />"><i class="fa fa-pencil-square-o"></i>  Sửa</a></li>--%>
                                            <%--</ul>--%>
                                        <%--</div>--%>
                                    </td>
                                </tr>
