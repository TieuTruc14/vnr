        ...
        <section class="scrollable padder">
            ...
            <section class="panel panel-default">
                ...
                <section class="panel-body">
                    <s:form id="filter" label="Tìm kiếm " action="station.stage.add.action" theme="simple" enctype="multipart/form-data" cssClass="form-horizontal" cssStyle="" validate="false">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label"></label>
                            <div class="col-sm-10">
                                <i>Thông tin khu đoạn (ex: Hà Nội-Giáp Bát)</i>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Khu đoạn <code>(*)</code></label>
                            <div class="col-sm-10">
                                <s:select theme="simple"
                                          cssClass="selectpicker span2 input-small input-sm input-s-sm form-control inline"
                                          label="Chọn ga"
                                          list="ListStageInterceptor_stages"
                                          listKey="id"
                                          listValue="name"
                                          name="item.stage.id"
                                          headerKey=""
                                          headerValue="Chọn khu đoạn"
                                          data-width="auto"
                                          cssStyle="width:300px"
                                        />
                            </div>
                        ...
                        <div class="form-group" >
                            ...
                            <div class="form-group col-md-12"> <div class="col-sm-12 col-sm-offset-2"> <button type="submit" class="btn btn-primary">Lưu</button>  <button  class="btn btn-info"><a href="station.stages.action" class="text-white">Quay lại</a></button>  </div> </div>
                        </div>
                    </s:form>
                </section>
            </section>
