                ...
                <section class="panel-body">
                    <s:form id="filter" label="Tìm kiếm " action="station.edit.action" theme="simple" enctype="multipart/form-data" cssClass="form-horizontal" cssStyle="" validate="false">
                        <div class="form-group" hidden="true">
                            <label class="col-sm-2 control-label">id <code>(*)</code></label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <i> Thông tin tên Ga (ex: Hà Nội)</i>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Ga <code>(*)</code></label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label"></label>
                            <div class="col-sm-10">
                                <i> Thông tin khu đoạn (ex: Hà Nội-Thanh hóa)</i>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Khoảng cách</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label"></label>
                            <div class="col-sm-10">
                                <label class="col-sm-2 control-label text-success"><s:property value="Status"/> </label>
                            </div>
                        </div>
                        </div>
                        <div class="form-group" >
