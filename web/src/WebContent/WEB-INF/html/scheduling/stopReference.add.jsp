    ...
    <section class="vbox">
        <section class="scrollable padder">
            ...
            <section class="panel panel-default">
                <header class="panel-heading"><i class="fa fa-caret-square-o-right"></i> Thêm lịch trình tàu mác <s:property value="trainReferenceId" /> - Khởi hành lúc  <span class="badge bg-info h4"><s:property value="@org.apache.commons.lang3.time.DurationFormatUtils@formatDuration(trainReference.departureTime, 'HH:mm')"/></span>
                ...
                <section class="panel-body">
                    <s:form id="filter" label="Tìm kiếm " action="/vnr/scheduling/stopReference.add.action" theme="simple" enctype="multipart/form-data" cssClass="form-horizontal" cssStyle="" validate="false">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label"></label>
                            <div class="col-sm-10">
                                <i>Thời gian tới ga, được tính bằng thời gian từ ga xuất phát tới ga hiện tại(Giả sử SE1 xuất phát ga HN lúc 19h, tới Thường tín lúc 20h30 thì thời gian đến ga thường tín điền là 1:30)
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label"></label>
                            <div class="col-sm-10">
                                <i>Thời gian rời ga, được tính bằng thời gian từ ga xuất phát tới ga hiện tại(Giả sử SE1 xuất phát ga HN lúc 19h, rời Thường tín lúc 21h30 thì thời gian đến ga thường tín điền là 2:30)</i>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label"></label>
                            <div class="col-sm-10">
                                <i>Nếu là ga tác nghiệp thì điền vào số phút tác nghiệp còn không thì bỏ trống hoặc điền =0.</i>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-sm-2 control-label">Thời gian tác nghiệp</label>
                            <div class="col-sm-10">
