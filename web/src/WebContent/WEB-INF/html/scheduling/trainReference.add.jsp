        ...
        <section class="scrollable padder">
            ...
            <section class="panel panel-default">
                ...
                <section class="panel-body">
                    <s:form id="filter" label="Tìm kiếm " action="/vnr/scheduling/trainReference.add.action" theme="simple" enctype="multipart/form-data" cssClass="form-horizontal" cssStyle="" validate="false">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <s:textfield name="departureTime" pattern="(([0-1][0-9])|([2][0-3])|([0-9])):([0-5][0-9])" Class=" span2 input-s-lg form-control inline" title="Định dạng HH:mm, ex:05:46" required="true" ></s:textfield>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label"></label>
