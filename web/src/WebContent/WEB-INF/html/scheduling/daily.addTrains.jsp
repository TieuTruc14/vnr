        ...
        <section class="scrollable padder">
            <div class="m-b-md">
                <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                    ...
                    <li><a href="#"> Thêm Tàu</a></li>
                </ul>
                <h3 class="m-b-none">Thêm Tàu từ Đoàn tàu Mẫu vào Kế hoạch chạy tàu</h3>
            ...
            <form class="form-horizontal" method="get" action="daily.addTrains.save.action">
            <section class="panel panel-default">
                <header class="panel-heading"> Danh sách Đoàn tàu Mẫu
                    <div class=" col-xs-6 pull-right">
                        <label class="col-sm-5 control-label text-danger-dker">CHỌN NGÀY THÊM</label>
                        <div class="col-sm-7">
